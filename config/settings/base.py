...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'internos.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:@localhost:5432/unicef'),
...
DATABASES = {
     'default': {
         ...
         'USER': 'postgres',
         'PASSWORD': 'Admin123!',
         'HOST': 'unicef.ci1hvlgwbpn9.us-east-1.rds.amazonaws.com',
         'PORT': '5432',
     }
}
# DATABASES = {
...
ACCOUNT_ADAPTER = 'internos.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'internos.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ["sslserver",'internos.taskapp.celery.CeleryConfig']
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['example.com', 'lebanondb.unicef.org', '127.0.0.1', '158.113.238.10', '10.16.160.44','neuro-db.org','[::1]'])
