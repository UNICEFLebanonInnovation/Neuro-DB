...
def get_indicator_hpm_data(ai_id, month=None):
    ...
    try:
        ...
        data = {
            ...
            'last_report_changes_bln': "{:,}".format(last_report_changes_bln),
            'last_report_changes_cbece': "{:,}".format(last_report_changes_cbece),
            'last_report_changes_alp': "{:,}".format(last_report_changes_alp),
