...
urlpatterns = [
    ...
    url(
        regex=r'^report-blast/$',
        view=views.ReportBlastView.as_view(),
        name='report_blast'
    ),
    url(
    ...
    url(
        regex=r'^report-partner-crisis/$',
        view=views.ReportPartnerCrisisView.as_view(),
        name='report_partner_crisis'
    ),
    url(
