...
from internos.helpdesk.models import Attachment, EmailTemplate
...
def send_templated_mail(template_name,
    ...
    from internos.helpdesk.models import EmailTemplate
    from internos.helpdesk.settings import HELPDESK_EMAIL_SUBJECT_TEMPLATE, \
...
def text_is_spam(text, request):
    ...
    try:
        from internos.helpdesk.akismet import Akismet
    except ImportError:
        return False
    try:
