...
from internos.helpdesk.models import CustomField, Queue, Ticket
...
from internos.helpdesk.templatetags.ticket_to_link import num_to_link
from internos.helpdesk.views.staff import _is_my_ticket
