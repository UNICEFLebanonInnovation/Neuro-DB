...
from internos.helpdesk import settings as helpdesk_settings
from internos.helpdesk.decorators import protect_view
from internos.helpdesk.forms import PublicTicketForm
from internos.helpdesk.lib import text_is_spam
from internos.helpdesk.models import Ticket, Queue, UserSettings, KBCategory
    ...
    if ticket_req and email:
        ...
        try:
            ...
            if 'close' in request.GET and ticket.status == Ticket.RESOLVED_STATUS:
                from internos.helpdesk.views.staff import update_ticket
