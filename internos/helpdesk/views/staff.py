...
from internos.helpdesk.forms import (
    TicketForm, UserSettingsForm, EmailIgnoreForm, EditTicketForm, TicketCCForm,
    TicketCCEmailForm, TicketCCUserForm, EditFollowUpForm, TicketDependencyForm
)
from internos.helpdesk.decorators import staff_member_required, superuser_required
from internos.helpdesk.lib import (
    send_templated_mail, apply_query, safe_template_context,
    process_attachments, queue_template_context,
)
from internos.helpdesk.models import (
...
def ticket_list(request):
    ...
    if request.GET.get('saved_query', None):
        ...
        import json
        from internos.helpdesk.lib import b64decode
        try:
            if six.PY3:
    ...
    import json
    from internos.helpdesk.lib import b64encode
